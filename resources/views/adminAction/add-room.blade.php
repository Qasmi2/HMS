                                     ...
                                     <div class="card-body">
                                        <form method="POST" action="{{ route('roomadd') }}">
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label for="price" class="col-md-4 col-form-label text-md-right">{{ __('NO. of Room') }}</label>
                                            ...
                                            <div class="form-group row">
                                                <label for="available" class="col-md-4 col-form-label text-md-right">{{ __('Room Type') }}</label>
