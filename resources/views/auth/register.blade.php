    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class=" col-md-offset-5 col-lg-offset-5 col-xs-12 col-sm-12 card-header">{{ __('Register') }}</div>
                <br><br><br>
                <div class="card-body">
                    <form method="POST" action="{{ route('regis') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="c_password" type="password" placeholder="Enter Re-password" class="form-control" name="c_password" required>
                            </div>
                        </div>
